...
export NEXUS_USERNAME=$(cat /opt/config/nexus_username.txt)
export NEXUS_PASSWD=$(cat /opt/config/nexus_password.txt)
export NEXUS_DOCKER_REPO=$(cat /opt/config/nexus_docker_repo.txt)
export DMAAP_TOPIC=$(cat /opt/config/dmaap_topic.txt)
export DOCKER_IMAGE_VERSION=$(cat /opt/config/docker_version.txt)
export DOCKER_REGISTRY=${NEXUS_DOCKER_REPO}

export RESOURCES_DOCKER_IMAGE_VERSION=1.2-STAGING-latest
export TRAVERSAL_DOCKER_IMAGE_VERSION=1.2-STAGING-latest
export SEARCH_DATA_SERVICE_DOCKER_IMAGE_VERSION=1.2-STAGING-latest
export DATA_ROUTER_DOCKER_IMAGE_VERSION=1.2-STAGING-latest
export MODEL_LOADER_DOCKER_IMAGE_VERSION=1.2-STAGING-latest
export SPARKY_BE_DOCKER_IMAGE_VERSION=1.2-STAGING-latest
export CHAMP_DOCKER_IMAGE_VERSION=1.2-STAGING-latest
export GIZMO_DOCKER_IMAGE_VERSION=1.2-STAGING-latest
export BABEL_DOCKER_IMAGE_VERSION=1.2-STAGING-latest
