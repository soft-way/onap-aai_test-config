...
RESOURCES_DOCKER_IMAGE_VERSION=1.2-STAGING-latest
TRAVERSAL_DOCKER_IMAGE_VERSION=1.2-STAGING-latest
SEARCH_DATA_SERVICE_DOCKER_IMAGE_VERSION=1.2-STAGING-latest
DATA_ROUTER_DOCKER_IMAGE_VERSION=1.2-STAGING-latest
MODEL_LOADER_DOCKER_IMAGE_VERSION=1.2-STAGING-latest
SPARKY_BE_DOCKER_IMAGE_VERSION=1.2-STAGING-latest
CHAMP_DOCKER_IMAGE_VERSION=1.2-STAGING-latest
GIZMO_DOCKER_IMAGE_VERSION=1.2-STAGING-latest
BABEL_DOCKER_IMAGE_VERSION=1.2-STAGING-latest
